...
// conversations" tab. Keeps the main bundle lean.
const RealConversationModule = lazy(
  () => import("../components/RealConversationModule"),
);
    ...
    >
      ...
      {view === "modules" && (
        <>
          ...
          {tab === "real-conversation" && (
            <Suspense fallback={<div className="flex min-h-[200px] items-center justify-center text-sm text-brand-200/60">…</div>}>
              <RealConversationModule language={lang} isLoggedIn={isLoggedIn} onNeedLogin={onNeedLogin} />
            </Suspense>
          )}
        </>
      )}
